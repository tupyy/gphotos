...
JSON Sample
-------------------------------------
{    "group_name": "liLamtXqCPzGTxNmPoBuiYJWP",    "album_id": 35,    "permissions": 7}
...
var album_group_permissionsTableInfo = &TableInfo{
	Name: "album_group_permissions",
	Columns: []*ColumnInfo{
...
func (a *AlbumGroupPermissions) TableName() string {
	return "album_group_permissions"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (a *AlbumGroupPermissions) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (a *AlbumGroupPermissions) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (a *AlbumGroupPermissions) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (a *AlbumGroupPermissions) TableInfo() *TableInfo {
	return album_group_permissionsTableInfo
}
