...
decrypt_realm:
	openssl enc -aes-256-cbc -d -md sha512 -pbkdf2 -iter 10000 -in ./gophoto-realm-prod.enc -out ./gophoto-realm-prod.json -pass file:$(KEY_FILE)
...
encrypt_realm:
	openssl enc -aes-256-cbc -md sha512 -pbkdf2 -iter 10000 -in ./gophoto-realm-prod.enc -out ./gophoto-realm-prod.json -pass file:$(KEY_FILE)
