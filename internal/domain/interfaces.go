...
type KeycloakRepo interface {
	...
	GetUsers(ctx context.Context, filters ...filters.UserFilter) ([]entity.User, error)
...
type Album interface {
	...
	Get(ctx context.Context, filters ...filters.AlbumFilter) ([]entity.Album, error)
	...
	GetByOwnerID(ctx context.Context, ownerID string, filters ...filters.AlbumFilter) ([]entity.Album, error)
	// GetByUserID returns a list of albums for which the user has at least one permission set.
	GetByUserID(ctx context.Context, userID string, filters ...filters.AlbumFilter) ([]entity.Album, error)
	// GetByGroup returns a list of albums for which the group has at least one permission.
	GetByGroupName(ctx context.Context, groupName string, filters ...filters.AlbumFilter) ([]entity.Album, error)
	// GetByGroups returns a list of albums with at least one persmission for at least on group in the list.
	GetByGroups(ctx context.Context, groups []string, filters ...filters.AlbumFilter) ([]entity.Album, error)
}
