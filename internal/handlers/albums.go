...
func (server *Server) GetAlbums(c *gin.Context, params apiv1.GetAlbumsParams) {
	...
	albumModels := make([]apiv1.UserAlbum, 0, len(albums))
...
func (server *Server) GetAlbumPermissions(c *gin.Context, albumId string, params apiv1.GetAlbumPermissionsParams) {
}

// (GET /api/gphotos/v1/auth/callback)
func (server *Server) GetApiGphotosV1AuthCallback(c *gin.Context, params apiv1.GetApiGphotosV1AuthCallbackParams) {
}
